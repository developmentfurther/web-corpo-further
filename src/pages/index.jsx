  ...
  return (
    ...
    >
      <div className={`${SHELL}`}>
        ...
        {/* === Contenido principal: Cards + Video === */}
          ...
          >
            {bullets.map((b, i) => (
              <motion.div
                ...
                className="group relative flex gap-4 p-5 rounded-xl bg-white border border-gray-200 shadow-sm hover:shadow-md hover:bg-gray-50 transition"
                role="listitem"
              >
